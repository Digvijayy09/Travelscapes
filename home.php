...
<header>
    ...
    <a href="#" class="logo"><span>Travel website</span></a>
...
<section class="products" id="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price">4<span>3</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price"> 1 <span>2</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price">  7 <span>8</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price"> 9 <span>10</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price"> 229<span>89</span> </div>
            </div>
        </div>
        ...
        <div class="box">
            ...
            <div class="content">
                <h3>Best Place</h3>
                <div class="price"> 899 <span>233</span> </div>
            </div>
        </div>
...
<div class="box-container">
    ...
    <div class="box">
        ...
        <p>Booking my dream trip to the serene backwaters of Kerala was a breeze with this travel website – seamless and stress-free! </p>
        <div class="user">
    ...
    <div class="box">
        ...
        <p>Thanks to this website, I explored the majestic beauty of Rajasthan with ease, and the deals were unbeatable!</p>
        <div class="user">
...
<section class="footer">
    ...
    <div class="credit">&copy; Atharva Kulkarni</div>
